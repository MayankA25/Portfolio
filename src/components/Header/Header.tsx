...
export default function Header() {
  ...
  return (
    <div className={`sticky top-0 z-4 flex items-center justify-between bg-neutral-50 dark:bg-black p-8 ${pathname == "/" ? "py-5" : "py-8"} dark:text-neutral-400 w-full text-neutral-800`}>
      ...
      <div className="flex items-center  gap-4 md:gap-8 ">
        <button onClick={()=>{
          ...
          {theme == "light" ? <Moon className="cursor-pointer transition-colors duration-200 fill:white  hover:fill-black dark:fill-black dark:hover:fill-white " /> : 
          <Sun className="cursor-pointer transition-colors duration-200 fill:white  hover:fill-black dark:fill-black dark:hover:fill-white"/>
          }
        </button>
